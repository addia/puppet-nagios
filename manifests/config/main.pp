...
class nagios::config::main (
  ...
  file_line { 'nagios.conf-10':
    ...
    path                               => '/etc/nagios/nagios.cfg',
    line                               => "host_perfdata_file_templateTATYPE::HOSTPERFDATA\tTIMET::\$TIMET\$\tHOSTNAME::\$HOSTNAME\$\tHOSTPERFDATA::\$HOSTPERFDATA\$\tHOSTCHECKCOMMAND::\$HOSTCHECKCOMMAND\$\tHOSTSTATE::\$HOSTSTATE\$\tHOSTSTATETYPE::\$HOSTSTATETYPE\$",
